"""Burn-in grading: shared by scripts/burnin_check.py and the console API.
Thresholds here ARE the burn-in plan thresholds (docs/burn-in-plan.md)."""

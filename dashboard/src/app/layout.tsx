  ...
  return (
    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* suppressHydrationWarning on these scripts: some extensions
            (Bitdefender's `bis_use`, etc.) rewrite inline scripts before React
            hydrates, mutating this very node. Suppress diffing for it. */}
        <script
        ...
        {/* Strip attributes injected by browser extensions (Bitdefender's
            ...
            don't trigger hydration-mismatch warnings on body nodes. Runs in
            <head> so the observer is live during the hydration window. */}
        <script
          suppressHydrationWarning
          dangerouslySetInnerHTML={{
